...
public class OBJ_DascoHouse extends Entity {
    public OBJ_DascoHouse(GamePanel gp){
        super(gp);
        name = "DascoHouse";
        down1 = setup("objects/DascoHouse", gp.tileSize, gp.tileSize); // Your house sprite file
        collision = true;
