...
public class OBJ_EmilyHouse extends Entity {
    public OBJ_EmilyHouse(GamePanel gp){
        super(gp);
        name = "EmilyHouse";
        down1 = setup("objects/EmilyHouse", gp.tileSize, gp.tileSize); // Your house sprite file
        collision = true;
