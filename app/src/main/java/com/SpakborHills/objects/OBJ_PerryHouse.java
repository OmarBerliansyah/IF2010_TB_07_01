...
public class OBJ_PerryHouse extends Entity {
    public OBJ_PerryHouse(GamePanel gp){
        super(gp);
        name = "PerryHouse";
        down1 = setup("objects/PerryHouse", gp.tileSize, gp.tileSize); // Your house sprite file
        collision = true;
