...
public class OBJ_Crimsonfish extends Entity implements Entity.FishableProperties { // Implementasikan interface

    // Field private untuk menyimpan data spesifik Crimsonfish
    ...
    public OBJ_Crimsonfish(GamePanel gp) {
        super(gp);
        name = "Crimsonfish";
        down1 = setup("objects/Crimsonfish", gp.tileSize, gp.tileSize); // Sesuaikan path gambar jika perlu
        description = "[" + name + "]\nIkan legendaris berwarna merah\nyang hidup di laut musim panas."; // Deskripsi bisa disesuaikan
        isPickable = true;
        isEdible = true;    // Ikan bisa dimakan
        plusEnergy = 1;     // Menambah 1 energi saat dimakan

        // Inisialisasi data FishableProperties untuk Crimsonfish
        ...
        this.availableEndTimes.add(20); // Sampai sebelum jam 20:00 (artinya 08:00 - 19:59)
                                        // Sesuai tabel awal: Crimsonfish, Summer, 08.00-20.00, Any, Ocean
    }
